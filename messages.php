    ...
    echo $html::openDiv(null,array("roww"));
        echo $html::openDiv("themessages",array("messScreen"));
            ...
            foreach ($allMessages as $key => $value) {
                ...
                $ddate = date('H:i',strtotime($value['senddate']));
                $line=$value['texte']."<p>".$ddate."</p>";

                    echo $html->span(null,array("message-text ",$alignement),$line);

                   // echo $html::span(null, array("torightdate"),$ddate);                
                echo $html->closeDiv();
            }
